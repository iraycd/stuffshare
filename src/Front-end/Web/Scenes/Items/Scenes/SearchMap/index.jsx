...
class SearchMap extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.getItems(0).then(succ => {
            this.setState({
                result: succ.data
            })
        })
    ...
    render() {
        ...
        //</Marker>
        let map = <Map
            minZoom={12} className="size-map-80vh" center={latlng} zoom={this.state.zoom}
            ref={(ref) => {
                this.map = ref;
        ...
        >
            <Circle opacity={0.5} center={latlng} fillColor="#666" color="#e74c3c" fillOpacity={0.1} radius={4000} strokeWidth={1} />
                ...
                {this.state.result ? this.state.result.map(item => {
                    ...
                    let myIcon = L.divIcon({
                        ...
                        <svg viewBox="0 0 80 80" width="40" height="70" style="overflow: visible;">
                            ...
                            <style>
                                .small { font: italic 13px sans-serif; }
                                .heavyText {bold; 500: 30px sans-serif; text-align:center }
                            ...
                            <g>
                            <text font-size="11" stroke-width="0" stroke="#000" alignment-baseline="middle" text-anchor="middle" class="heavy" x="35" y="-15">${this.showValue(cat)}</text>
                        ...
                        <Popup>
                            ...
                            <div xs="9" class="media g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-blue-left g-pa-5 rounded-0  g-mb-2">
                                ...
                                <div class="media-body g-pl-5">
                                    ...
                                    <span class="u-label u-label--sm g-bg-blue g-rounded-20 g-px-10">Centru</span>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getItems: (category_id) => {
            return dispatch(new BaseService().queryThunt(QueryList.Item.GET_ITEM, { id: category_id }));
