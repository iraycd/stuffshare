...
import CategoryOptionGEO_SINGLE from './CategoryOptionGEO_SINGLE.jsx';
import Checkbox from '../../../../../Components/FormComponent/Components/Checkbox/index.jsx';


class CategoryOptionGEO extends React.Component {
    ...
    constructor(props) {
        ...
        if (this.props.catOption.cat_opt_temp==undefined || this.props.catOption.cat_opt_temp.length == 0) {
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 1,"X");
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 2,"Y")
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 3,"Kraj")
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 4,"Kraj Id")
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 5,"Miasto"),
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 6,"Miasto Id"),
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 7,"Adres")
        }
                    ...
                    <ListGroup>
                        {this.props.catOption.cat_opt_temp ? this.props.catOption.cat_opt_temp.map(item => {
                            return <Collapsible triggerDisabled={this.state.catOption.category_id != undefined && this.state.catOption.category_id != this.props.category_id} triggerClassName="Collapsible__trigger_options" triggerOpenedClassName="Collapsible__trigger_options" lazyRender={true} trigger={item.placeholder}>
                                <CategoryOptionGEO_SINGLE catSingleOption={item} coId={this.state.catOption.id} cottId={this.state.cott_id} type={this.state.cott_type} catOptId={this.state.catOption.id}></CategoryOptionGEO_SINGLE>
                            </Collapsible>
                        }) : <span></span>}
