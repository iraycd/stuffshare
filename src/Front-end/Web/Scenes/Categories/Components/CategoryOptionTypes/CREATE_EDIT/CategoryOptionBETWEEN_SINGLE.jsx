    ...
    submitHanlder(event) {
        ...
        if (validator.length == 0) {
            ...
            if (this.state.catOption.cat_opt_temp == undefined) {
                ...
                this.state.catOption.cat_opt_temp.push({ id: uuidv4(), co_id: this.state.catOption.id, placeholder: 'NEW ELEMENT',order:1 })
                this.state.catOption.cat_opt_temp.push({ id: uuidv4(), co_id: this.state.catOption.id, placeholder: 'NEW ELEMENT',order:2 })
