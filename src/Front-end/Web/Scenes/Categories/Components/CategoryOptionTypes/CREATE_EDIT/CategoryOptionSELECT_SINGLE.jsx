...
class CategoryOptionSELECT_SINGLE extends React.Component {
    ...
    translateSubmit(event) {
        ...
        translate(this.state.catOption.value, { engine: 'yandex', key: 'trnsl.1.1.20190525T222610Z.47a7d82b340b189e.59764ef074ae84f21bed0836d101d4743a754577', from: langFrom, to: lang }).then(text => {
    ...
    render() {
        ...
        return (<Container className="g-ma-10">
            <Form className="text-center">
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_PL_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_PL_LABEL')} value={this.state.catOption.value_pl} onChange={(event) => { this.state.catOption.value_pl = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_pl" validation={this.state.validation} />
                    </Col>
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_US_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_US_LABEL')} value={this.state.catOption.value_us} onChange={(event) => { this.state.catOption.value_us = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_us" validation={this.state.validation} />
                    </Col>
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_DE_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_DE_LABEL')} value={this.state.catOption.value_de} onChange={(event) => { this.state.catOption.value_de = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_de" validation={this.state.validation} />
                    </Col>
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_RU_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_RU_LABEL')} value={this.state.catOption.value_ru} onChange={(event) => { this.state.catOption.value_ru = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_ru" validation={this.state.validation} />
                    </Col>
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_FR_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_FR_LABEL')} value={this.state.catOption.value_fr} onChange={(event) => { this.state.catOption.value_fr = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_fr" validation={this.state.validation} />
                    </Col>
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_ES_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_ES_LABEL')} value={this.state.catOption.value_es} onChange={(event) => { this.state.catOption.value_es = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_es" validation={this.state.validation} />
                    </Col>
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_NO_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_NO_LABEL')} value={this.state.catOption.value_no} onChange={(event) => { this.state.catOption.value_no = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_no" validation={this.state.validation} />
                    </Col>
                ...
                <Row>
                    <Col>
                        <TextBox placeholder={phTrans.translate('OPTION_NAME_ZH_CN_PLACEHOLDER')} isRequired={true} label={tran.translate('OPTION_NAME_ZH_CN_LABEL')} value={this.state.catOption.value_zh_cn} onChange={(event) => { this.state.catOption.value_zh_cn = event.target.value; this.refreshValidation.bind(this)(); this.setState({ catOption: this.state.catOption }) }} field="value_zh_cn" validation={this.state.validation} />
                    </Col>
                ...
                <ButtonLoader onClick={this.removeHanlder.bind(this)} size={"md"} className={"btn g-letter-spacing-1 g-font-weight-700 g-font-size-12 text-uppercase u-btn-primary rounded-0"} value={"Delete"} isLoading={this.state.isDeleteLoading} />
