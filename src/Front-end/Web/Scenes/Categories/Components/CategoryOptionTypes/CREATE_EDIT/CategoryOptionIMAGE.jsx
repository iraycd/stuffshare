...
class CategoryOptionIMAGE extends React.Component {
    ...
    constructor(props) {
        ...
        if (this.props.catOption.cat_opt_temp==undefined || this.props.catOption.cat_opt_temp.length == 0) {
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 1,"GUID")
            props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 2,"Jest główne")
